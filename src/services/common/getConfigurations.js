import requestApiPrivate from '@sistec/services/requestApiPrivate'
...
export function getPageJsonConfiguration(origen, codigo, token) {
  const config = {
    method: 'get',
  ...
  return requestApiPrivate(config)
}
