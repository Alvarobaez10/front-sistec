  ...
  return (
    <div className="relative inline-block " ref={wrapRef}>
      <button
        ...
        h-[35px] flex items-center justify-between"
      >
        <div className="flex items-center gap-2">
          <svg className="w-4 h-4 text-gray-600" viewBox="0 0 24 24" fill="none">
            <path
              d="M7 11V13M17 11V13M3 7h18M5 21h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2Z"
              stroke="currentColor"
              strokeWidth="1.2"
              strokeLinecap="round"
          ...
          <span
            className={`text-sm ${!value?.from && !value?.to ? 'text-gray-400' : 'text-gray-700'}`}
          >
            {formatLabel()}
          </span>
        </div>
      ...
      {open && (
        <div
          className="absolute z-50 mt-1  w-full border border-gray-300 text-sm 
          rounded-md shadow-lg p-3"
        >
          <div className="flex flex-col gap-2">
            <label className="text-xs text-gray-800">Desde</label>
            <input
              type="date"
              value={localFrom}
            ...
            <label className="text-xs text-gray-800">Hasta</label>
            <input
              type="date"
              value={localTo}
            ...
            <div className="flex gap-2 justify-end pt-2">
              <button type="button" onClick={clear} className="btn-accent text-xs">
                Limpiar
              </button>
